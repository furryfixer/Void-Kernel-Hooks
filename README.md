# Void-Kernel-Hooks
Scripts to be placed in various /etc/kernel.d/ subdirectories to link the most recently installed kernel to an invariant name for grub. This mimics the behaviour of Arch linux when it comes to kernel upgrades. 
